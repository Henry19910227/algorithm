...
func TestCircleArrayQueue_IsEmpty(t *testing.T) {
...
func TestCircleArrayQueue_IsFull(t *testing.T) {
	queue := NewCircleArrayQueue(3)
...
func TestCircleArrayQueue_Head(t *testing.T) {
	queue := NewCircleArrayQueue(3)
	queue.Push(1)
	queue.Push(2)
	queue.Push(3)
...
func TestCircleArrayQueue_Size(t *testing.T) {
	queue := NewCircleArrayQueue(3)
	queue.Push(1)
	queue.Push(2)
	queue.Push(3)
